...
// import hyperverglogo from "../../../public/"
  ...
  return (
    <div>
      <div className='bg-gray-900 text-white w-full h-43 flex items-center justify-around p-4'>
        <p className='text-4xl p-2 flex border items-center gap-2 bg-sky-50 rounded-md'><img src='../../../public/hyperverge-logo.webp' className='w-40 h-28 bg-white rounded-md shadow-lg'/> <span className='flex text-gray-500 font-extrabold'>Academy <TbSchool/></span> </p>
